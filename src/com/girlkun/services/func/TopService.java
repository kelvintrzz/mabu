                ...
                if (Manager.timeRealTop + (30 * 60 * 1000) < System.currentTimeMillis()) {
                    ...
                    try (Connection con = GirlkunDB.getConnection()) {
                        ...
                        Manager.topSM = Manager.realTop(Manager.queryTopSM, con);
                         Manager.topKhi = Manager.realTop(Manager.queryTopKhi, con);
                         Manager.topDSK = Manager.realTop(Manager.queryTopDSK, con);                         
                         Manager.topDiem = Manager.realTop(Manager.queryTopDiem, con);
