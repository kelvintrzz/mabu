...
public class OngNoel extends Boss {

    public OngNoel() throws Exception {
        super(BossID.ONGNOEL, BossesData.ONGNOEL);
    }

    @Override
    public void reward(Player plKill) {
        int[] itemDos = new int[]{2106,2111,2113};
        ...
        if(randomDo == 2113){
            mvbt.options.add(new Item.ItemOption(9, 0));
        }
