...
public class Rong2024 extends Boss {

    public Rong2024() throws Exception {
        super(BossID.RONGVANG, BossesData.RONGVANG);
    }
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(30, 100)) {
            ...
            int randomHP = Util.nextInt(120, 200);
            int randomTC = Util.nextInt(20, 40);
            int randomKI = Util.nextInt(100, 140);
            int randomChiMang = Util.nextInt(20, 30);
